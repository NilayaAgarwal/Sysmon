...
def bytes_to_bit(bytes, per_second_flag=0, r=2):                                                # for conversion of  given bytes to bit
    if bytes * 8 > 1e12:
...
def bytes_to_byte(bytes, per_second_flag=0, r=2):                                            # for conversion of  given bytes to byte
    if bytes > 1e12:
...
def bytes_to_bibyte(bytes, per_second_flag=0, r=2):                                           # for conversion of  given bytes to binary prefix of byte
    if bytes > 1024**4:
...
class MainWindow(QtWidgets.QMainWindow):
    def runningprocess_info(self, *args, **kwargs):                                            # for details of running processes   #retrieves details from ps aux command
    ...
    def plot_cpuinfo(self,):                                                                # for CPU details   #retrieves details from  /proc/cpuinfo
        counter = 0
        p = []
    ...
    def plot_meminfo(self,):                                                                             # for memory usage   #retrieves details from  /proc/meminfo
        p = []
    ...
    def plot_netinfo(self,):                                                                            # for network usage   #retrieves details from  /proc/net/dev
        p = []
    ...
    def plot_diskinfo(self,):                                                                       # for disks usage   #retrieves details from  /proc/diskstats
        p = []
